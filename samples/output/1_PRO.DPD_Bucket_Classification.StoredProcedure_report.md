...
### Calculation — @GraceWindowStart

**Expression:**

```sql
DATEADD(DAY, -3, @ProcessDate)
```
...
### Calculation — DpdDays (first UPDATE)
...
### Calculation — PenalInterestAmount (BUCKET_1_30)

**Expression:**

```sql
(OutstandingBalance * 0.02) / 365 * DpdDays
```
...
### Calculation — PenalInterestAmount (BUCKET_31_60)

**Expression:**

```sql
(OutstandingBalance * 0.03) / 365 * DpdDays
```
...
### Calculation — PenalInterestAmount (BUCKET_61_90 / BUCKET_90_PLUS)

**Expression:**

```sql
(OutstandingBalance * 0.04) / 365 * DpdDays
```
...
### Calculation — AdjustedPenalty (CC/OD)

**Expression:**

```sql
AdjustedPenalty * 1.10
```
...
### Calculation — AdjustedPenalty (TL/DL)

**Expression:**

```sql
AdjustedPenalty * 1.05
```
