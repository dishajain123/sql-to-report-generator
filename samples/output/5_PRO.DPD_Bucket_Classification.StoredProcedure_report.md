...
### Calculation — DpdBucket

**Expression:**

```sql
CASE
    WHEN DpdDays IS NULL THEN 'NOT_APPLICABLE'
    WHEN DpdDays = 0 THEN 'CURRENT'
    WHEN DpdDays BETWEEN 1 AND 30 THEN 'BUCKET_1_30'
    WHEN DpdDays BETWEEN 31 AND 60 THEN 'BUCKET_31_60'
    WHEN DpdDays BETWEEN 61 AND 90 THEN 'BUCKET_61_90'
    ELSE 'BUCKET_90_PLUS'
END
```
