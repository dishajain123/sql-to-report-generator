...
| Run Timestamp | `2026-09-16T12:04:54.996240+00:00` |
| Object ID | `obj_8ece2542e210` |
...
| Item | Value |
|---|---|
| Run ID | `telemetry_58cd00834dd5` |
| Total LLM Calls | `1` |
| Successful Calls | `1` |
| Failed Calls | `0` |
| Prompt Tokens | `4522` |
| Completion Tokens | `4295` |
| Total Tokens | `8817` |
| Telemetry Availability | `available` |

| Stage | Calls | Success | Failure | Tokens | Availability |
|---|---:|---:|---:|---:|---|
| extraction | 1 | 1 | 0 | 8817 | available |
...
| tsql_if_0068_0083:branch_002 | ELSE | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql \| Lines 75-79 \| Chunk 02_batch3_nested_block |
...
- **Disposition:** covered_by_rule=40, technical_only=9, uncovered=50
...
| UPDATE_TEMP | technical_only | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | 01_batch3_main_body+batch3_nested_block:chunk_text_01, 01_batch3_main_body+batch3_nested_block:chunk_text_01, 01_batch3_main_body+batch3_nested_block | UPDATE S SET S.ReviewReason = ( CASE WHEN S.CoverageRatio IS NULL THEN 'NO_BALANCE' WHEN S.CoverageRatio < 0.25 THEN 'SEVERE_UNDERCOVER' WHEN S.CoverageRatio < 0.5 THEN 'MODERATE_UNDERCOVER' WHEN S.CoverageRatio >= 0.5 AND S.CoverageRati... |
| UPDATE_TEMP | technical_only | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | 01_batch3_main_body+batch3_nested_block:chunk_text_04, 01_batch3_main_body+batch3_nested_block:chunk_text_04, 01_batch3_main_body+batch3_nested_block | UPDATE S SET S.ReviewReason = S.ReviewReason + '_QUARTER_END' FROM #ProvisionCoverage S WHERE S.CoverageRatio IS NOT NULL AND S.CoverageRatio < 0.6 |
...
| UPDATE_TEMP | technical_only | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql / Lines 75-79 | 02_batch3_nested_block:chunk_text_02, 02_batch3_nested_block:chunk_text_02, 02_batch3_nested_block | UPDATE S SET S.ReviewReason = S.ReviewReason FROM #ProvisionCoverage S WHERE S.CoverageRatio IS NOT NULL AND S.CoverageRatio < 0.5 |
...
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql / Lines 75-79 | 02_batch3_nested_block | ELSE |
...
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | S.CoverageRatio IS NULL |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | S.CoverageRatio < 0.25 |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | S.CoverageRatio < 0.5 |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | S.CoverageRatio >= 0.5 AND S.CoverageRatio < 1 |
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | ELSE |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | CoverageRatio < 0.25 |
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmpv2e62a6j.sql | full_source | ELSE |
...
- **Quality score:** 86.98181818181818/100
...
- Synthesis section failed (chunks ['00_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~9218 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['01_batch3_main_body+batch3_nested_block']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8785 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['01_batch3_main_body+batch3_nested_block']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8836 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['02_batch3_nested_block']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8452 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['03_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8519 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['03_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8697 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['04_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~9010 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['04_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~9169 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed (chunks ['05_batch3_exception']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8495 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
