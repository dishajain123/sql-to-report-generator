...
| Run Timestamp | `2026-09-16T12:25:04.893338+00:00` |
| Object ID | `obj_8ece2542e210` |
...
| Item | Value |
|---|---|
| Run ID | `telemetry_660b8819d086` |
| Total LLM Calls | `1` |
| Successful Calls | `1` |
| Failed Calls | `0` |
| Prompt Tokens | `4522` |
| Completion Tokens | `3686` |
| Total Tokens | `8208` |
| Telemetry Availability | `available` |

| Stage | Calls | Success | Failure | Tokens | Availability |
|---|---:|---:|---:|---:|---|
| extraction | 1 | 1 | 0 | 8208 | available |
...
|---|---|---|
| decision_1348_1980_3:branch_001 | A.OutstandingBalance > 0 | source \| Lines 40-54 \| Statement 00_batch3_main_body:chunk_text_09 |
| decision_1348_1980_3:branch_002 | ELSE | source \| Lines 40-54 \| Statement 00_batch3_main_body:chunk_text_09 |
| case_0056_0062_2036:branch_001 | S.CoverageRatio IS NULL | source \| Lines 57-58 |
| case_0056_0062_2036:branch_002 | S.CoverageRatio < 0.25 | source \| Lines 58-59 |
| case_0056_0062_2036:branch_003 | S.CoverageRatio < 0.5 | source \| Lines 59-60 |
| case_0056_0062_2036:branch_004 | S.CoverageRatio >= 0.5 AND S.CoverageRatio < 1 | source \| Lines 60-61 |
| case_0056_0062_2036:branch_005 | ELSE | source \| Lines 61-62 |
| tsql_if_0068_0083:branch_001 | @ProcessDate >= DATEADD(MONTH, 1, @QuarterStartDate) | source \| Lines 69-73 |
| tsql_if_0068_0083:branch_002 | ELSE | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql \| Lines 75-79 \| Chunk 02_batch3_nested_block |
...
| decision_chain_007:branch_001 | A.OutstandingBalance > 0 | source |
| decision_chain_007:branch_002 | ELSE | source |
...
- **Executable constructs:** 101
- **Disposition:** covered_by_rule=42, technical_only=9, uncovered=50
...
| INSERT | uncovered | Lines 23-28 | 04_batch3_main_body:chunk_text_03, 04_batch3_main_body | INSERT INTO PRO.CollectionsQueue (AccountId, EscalationDate, Reason) SELECT AccountId, @ProcessDate, CASE WHEN CoverageRatio < 0.25 THEN 'SEVERE_PROVISION_SHORTFALL' ELSE 'MODERATE_PROVISION_SHORTFALL' END FROM #ProvisionCoverage WHERE R... |
...
| INSERT | uncovered | Lines 23-28 | 04_batch3_main_body:embedded_03_08, 04_batch3_main_body | INSERT INTO PRO.CollectionsQueue (AccountId, EscalationDate, Reason) SELECT AccountId, @ProcessDate, CASE WHEN CoverageRatio < 0.25 THEN 'SEVERE_PROVISION_SHORTFALL' ELSE 'MODERATE_PROVISION_SHORTFALL' END FROM #ProvisionCoverage WHERE R... |
...
| UPDATE_TEMP | technical_only | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | 01_batch3_main_body+batch3_nested_block:chunk_text_01, 01_batch3_main_body+batch3_nested_block:chunk_text_01, 01_batch3_main_body+batch3_nested_block | UPDATE S SET S.ReviewReason = ( CASE WHEN S.CoverageRatio IS NULL THEN 'NO_BALANCE' WHEN S.CoverageRatio < 0.25 THEN 'SEVERE_UNDERCOVER' WHEN S.CoverageRatio < 0.5 THEN 'MODERATE_UNDERCOVER' WHEN S.CoverageRatio >= 0.5 AND S.CoverageRati... |
| UPDATE_TEMP | technical_only | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | 01_batch3_main_body+batch3_nested_block:chunk_text_04, 01_batch3_main_body+batch3_nested_block:chunk_text_04, 01_batch3_main_body+batch3_nested_block | UPDATE S SET S.ReviewReason = S.ReviewReason + '_QUARTER_END' FROM #ProvisionCoverage S WHERE S.CoverageRatio IS NOT NULL AND S.CoverageRatio < 0.6 |
...
| UPDATE_TEMP | technical_only | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql / Lines 75-79 | 02_batch3_nested_block:chunk_text_02, 02_batch3_nested_block:chunk_text_02, 02_batch3_nested_block | UPDATE S SET S.ReviewReason = S.ReviewReason FROM #ProvisionCoverage S WHERE S.CoverageRatio IS NOT NULL AND S.CoverageRatio < 0.5 |
...
| INSERT | uncovered | unavailable | 04_batch3_main_body:embedded_03_08, 04_batch3_main_body:embedded_03_08, 04_batch3_main_body | INSERT INTO PRO.CollectionsQueue (AccountId, EscalationDate, Reason) SELECT AccountId, @ProcessDate, CASE WHEN CoverageRatio < 0.25 THEN 'SEVERE_PROVISION_SHORTFALL' ELSE 'MODERATE_PROVISION_SHORTFALL' END FROM #ProvisionCoverage WHERE R... |
...
| IF_BRANCH | covered_by_rule | Lines 40-54 | 00_batch3_main_body:chunk_text_09 | A.OutstandingBalance > 0 |
| ELSE | covered_by_rule | Lines 40-54 | 00_batch3_main_body:chunk_text_09 | ELSE |
| CASE | covered_by_rule | Lines 57-58 | unavailable | S.CoverageRatio IS NULL |
| CASE | covered_by_rule | Lines 58-59 | unavailable | S.CoverageRatio < 0.25 |
| CASE | covered_by_rule | Lines 59-60 | unavailable | S.CoverageRatio < 0.5 |
| CASE | covered_by_rule | Lines 60-61 | unavailable | S.CoverageRatio >= 0.5 AND S.CoverageRatio < 1 |
...
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql / Lines 75-79 | 02_batch3_nested_block | ELSE |
...
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | S.CoverageRatio IS NULL |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | S.CoverageRatio < 0.25 |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | S.CoverageRatio < 0.5 |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | S.CoverageRatio >= 0.5 AND S.CoverageRatio < 1 |
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | ELSE |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | CoverageRatio < 0.25 |
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | ELSE |
| IF_BRANCH | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | A.OutstandingBalance > 0 |
| ELSE | covered_by_rule | /var/folders/d5/q6cyw5854xz1ksr1wj0fmf5r0000gn/T/tmp8t4um57s.sql | full_source | ELSE |
...
- `LLM_ONLY` tables_read (`recon_527bb1173981`): full_source
...
- **Quality score:** 87.75438596491227/100
...
- Synthesis section failed after 1 attempt(s) (chunks ['00_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~9218 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['01_batch3_main_body+batch3_nested_block']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8785 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['01_batch3_main_body+batch3_nested_block']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8836 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['02_batch3_nested_block']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8452 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['03_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8519 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['03_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8697 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['04_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~9010 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['04_batch3_main_body']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~9169 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesis section failed after 1 attempt(s) (chunks ['05_batch3_exception']): Synthesis prompt for 'Provision_Coverage_Merge' is estimated at ~8495 tokens, which leaves no room under LLM_TPM_LIMIT=8000 even for the smallest useful completion. Either raise LLM_TPM_LIMIT to match what your account's rate-limit page actually shows, or reduce SYNTHESIS_EVIDENCE_MAP_MAX_CHARS / SYNTHESIS_SECTION_MAX_CHARS so each synthesis section carries less content.
- Synthesized in 9 section(s) aligned to extraction chunk boundaries because the object exceeded the single-call output-token ceiling; sections were merged into this report.
