...
| Dialect | T-SQL |
| Input | `@TimeKey` (INT) |
| Business rules | 1 confident, 4 needs review |
| Tables read | 4 |
| Tables written | 3 |
...
| ⚠️ Update review reason | `ReviewReason` | Update the review reason based on the coverage ratio. |
...
### R2 — Conditionally append to review reason
...
### R5 — Merge data into summary table
