...
| Run Timestamp | `2026-09-16T09:39:18.314228+00:00` |
| Object ID | `obj_9cfe9a17e845` |
...
| Item | Value |
|---|---|
| Run ID | `telemetry_efa2cd3802b5` |
| Total LLM Calls | `9` |
| Successful Calls | `9` |
| Failed Calls | `0` |
| Prompt Tokens | `114072` |
| Completion Tokens | `16901` |
| Total Tokens | `130973` |
| Telemetry Availability | `available` |

| Stage | Calls | Success | Failure | Tokens | Availability |
|---|---:|---:|---:|---:|---|
| extraction | 1 | 1 | 0 | 6620 | available |
| synthesis | 7 | 7 | 0 | 91598 | available |
| synthesis_revision | 1 | 1 | 0 | 32755 | available |

## Business Rule Summary

| Priority | Rule | Output | Business Purpose |
|---|---|---|---|
| 🟢 1 | Update UtilizationRatio [MATCHED] (`rule__1`) | `UtilizationRatio` | Set the UtilizationRatio for customers based on their risk profile. |
| 🟢 2 | Update RiskScore [MATCHED] (`rule__2`) | `RiskScore` | Set the RiskScore for customers based on their risk profile. |
| 🟢 3 | Update RiskTier [MATCHED] (`rule__3`) | `RiskTier` | Set the RiskTier for customers based on their risk profile. |
| 🟢 4 | Update RecommendedLimitAdjustmentPct [MATCHED] (`rule__4`) | `RecommendedLimitAdjustmentPct` | Set the RecommendedLimitAdjustmentPct for customers based on their risk profile. |
| 🟢 5 | Calculate Utilization Ratio [MATCHED] (`rule__1__13`) | `UtilizationRatio` | Determine the utilization ratio for a customer based on their current balance and credit limit. |
| 🟢 6 | Calculate Risk Score [MATCHED] (`rule__2__14`) | `RiskScore` | Determine the risk score for a customer based on their overdue days, utilization ratio, and prior default count. |
| 🔴 7 | Determine Risk Tier [CONFLICT] (`rule__3__15`) | `RiskTier` | Classify the risk tier for a customer based on their risk score. |
| 🔴 8 | Calculate Recommended Limit Adjustment Percentage [CONFLICT] (`rule__4__16`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for a customer based on their risk tier and prior default count. |
| 🟠 9 | Determine RiskTier [MATCHED] (`deterministic_case_0046_0051_1660_risktier`) | `RiskTier` | First matching row wins; ELSE includes false or NULL predicates. |
| 🟠 10 | Determine RecommendedLimitAdjustmentPct [MATCHED] (`deterministic_decision_2205_2686_0_recommendedlimitadjustmentpct`) | `RecommendedLimitAdjustmentPct` | First matching row wins. SQL type conversion still applies; ELSE includes false or NULL predicates. |
| 🟢 11 | Calculate UtilizationRatio [MATCHED] (`rule__1__5`) | `UtilizationRatio` | Determine the UtilizationRatio for customers with a non-null and positive CreditLimit. |
| 🔴 12 | Calculate RiskScore [CONFLICT] (`rule__2__6`) | `RiskScore` | Calculate the RiskScore for customers based on overdue days, utilization ratio, and prior defaults. |
| 🟢 13 | Determine RiskTier [MATCHED] (`rule__3__7`) | `RiskTier` | Determine the RiskTier for customers based on the composite RiskScore. |
| 🟢 14 | Calculate RecommendedLimitAdjustmentPct [MATCHED] (`rule__4__8`) | `RecommendedLimitAdjustmentPct` | Calculate the RecommendedLimitAdjustmentPct for customers based on their RiskTier and prior default count. |
| 🟢 15 | Calculate Utilization Ratio [MATCHED] (`rule__1__9`) | `UtilizationRatio` | Determine the utilization ratio for a customer based on their current balance and credit limit. |
| 🔴 16 | Calculate Risk Score [CONFLICT] (`rule__2__10`) | `RiskScore` | Determine the risk score for a customer based on their overdue days, utilization ratio, and prior default count. |
| 🟢 17 | Determine Risk Tier [MATCHED] (`rule__3__11`) | `RiskTier` | Classify the risk tier for a customer based on their risk score. |
| 🟢 18 | Calculate Recommended Limit Adjustment Percentage [MATCHED] (`rule__4__12`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for a customer based on their risk tier and prior default count. |
| 🟢 19 | Calculate Utilization Ratio [MATCHED] (`rule__1__17`) | `UtilizationRatio` | Determine the utilization ratio for customers with a non-null and positive credit limit. |
| 🔴 20 | Calculate Risk Score [CONFLICT] (`rule__2__18`) | `RiskScore` | Determine the risk score for customers based on their overdue days, utilization ratio, and prior defaults. |
| 🟢 21 | Calculate Recommended Limit Adjustment Percentage [MATCHED] (`rule__4__20`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for customers based on their risk tier and prior defaults. |
| 🟢 22 | Stage Updated Risk Scores and Tiers [MATCHED] (`rule__5`) | `CustomerId, RiskScore, RiskTier` | Stage the updated risk scores and tiers for customers. |
| 🟠 23 | Merge Updated Risk Scores and Tiers into History [LLM_ONLY] (`rule__6`) | `CustomerId, RiskScore, RiskTier` | Merge the staged risk scores and tiers into the risk score history. |
| 🟠 24 | Log Updated Risk Scores and Tiers for Audit [LLM_ONLY] (`rule__7`) | `CustomerId, ScoreDate, RiskScore, RiskTier` | Log the updated risk scores and tiers for audit purposes. |
| 🟢 25 | Calculate Utilization Ratio [MATCHED] (`rule__1__24`) | `UtilizationRatio` | Determine the utilization ratio for customers with a non-null and positive credit limit. |
| 🔴 26 | Calculate Risk Score [CONFLICT] (`rule__2__25`) | `RiskScore` | Determine the risk score for customers based on overdue days, utilization ratio, and prior defaults. |
| 🟢 27 | Determine Risk Tier [MATCHED] (`rule__3__26`) | `RiskTier` | Determine the risk tier for customers based on their composite risk score. |
| 🔴 28 | Calculate Recommended Limit Adjustment Percentage [CONFLICT] (`rule__4__27`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage based on the risk tier and prior default count. |
| 🔴 29 | Update Customer Risk Profile [CONFLICT] (`rule__5__28`) | `RiskScore, RiskTier, RecommendedLimitAdjustmentPct` | Update the customer's risk profile with the calculated risk score, risk tier, and recommended limit adjustment percentage. |
| 🟠 30 | Stage Risk Score and Risk Tier [UNRESOLVED] (`rule__6__29`) | `Not specified` | Stage the customer's risk score and risk tier for later processing. |
| 🟠 31 | Merge Risk Score and Risk Tier into History [LLM_ONLY] (`rule__7__30`) | `Not specified` | Merge the customer's risk score and risk tier into the risk score history. |
| 🟠 32 | Log Risk Score and Risk Tier [UNRESOLVED] (`rule__8`) | `Not specified` | Log the customer's risk score and risk tier into the risk score audit log. |
| 🟢 33 | Calculate UtilizationRatio [MATCHED] (`rule__1__32`) | `UtilizationRatio` | Determine the utilization ratio for each customer by dividing the current balance by the credit limit. |
| 🔴 34 | Calculate RiskScore [CONFLICT] (`rule__2__33`) | `RiskScore` | Determine the risk score for each customer based on overdue days, utilization ratio, and prior defaults. |
| 🟢 35 | Calculate RecommendedLimitAdjustmentPct [MATCHED] (`rule__4__35`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for each customer based on their risk tier and prior default count. |
...
|---|---|---|---|---|---|---|
| 1 | Update UtilizationRatio (rule__1) | C.UtilizationRatio condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_29 | dependency_0001; dependency_0002 | Verified |
| 2 | Update RiskScore (rule__2) | C.RiskScore condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_30 | dependency_0003; dependency_0004 | Verified |
| 3 | Update RiskTier (rule__3) | C.RiskTier condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_31 | dependency_0005; dependency_0006 | Verified |
| 4 | Update RecommendedLimitAdjustmentPct (rule__4) | C.RecommendedLimitAdjustmentPct condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_32 | dependency_0007; dependency_0008; dependency_0009; dependency_0010; dependency_0011 | Verified |
| 5 | Calculate Utilization Ratio (rule__1__13) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_29 | dependency_0001; dependency_0002 | Verified |
| 6 | Calculate Risk Score (rule__2__14) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_30 | dependency_0003; dependency_0004 | Verified |
| 7 | Determine Risk Tier (rule__3__15) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore < 30 THEN 'LOW' WHEN C.RiskScore >= 30 AND C.RiskScore < 60 THEN 'MODERATE' WHEN C.RiskScore >= 60 AND C.RiskScore < 90 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_31 | dependency_0005; dependency_0006 | Needs Review |
| 8 | Calculate Recommended Limit Adjustment Percentage (rule__4__16) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_32 | dependency_0007; dependency_0008; dependency_0009; dependency_0010; dependency_0011 | Needs Review |
| 9 | Determine RiskTier (deterministic_case_0046_0051_1660_risktier) | Not cited | source \| Lines 46-51 | Not cited | Not cited | Verified |
| 10 | Determine RecommendedLimitAdjustmentPct (deterministic_decision_2205_2686_0_recommendedlimitadjustmentpct) | Not cited | source \| Lines 60-71 | Not cited | Not cited | Verified |
| 11 | Calculate UtilizationRatio (rule__1__5) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 12 | Calculate RiskScore (rule__2__6) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Needs Review |
| 13 | Determine RiskTier (rule__3__7) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore < 50 THEN 'LOW' WHEN C.RiskScore >= 50 AND C.RiskScore < 75 THEN 'MODERATE' WHEN C.RiskScore >= 75 AND C.RiskScore < 100 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NULL | Not cited | Not cited | Not cited | Verified |
| 14 | Calculate RecommendedLimitAdjustmentPct (rule__4__8) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | Not cited | Not cited | Verified |
| 15 | Calculate Utilization Ratio (rule__1__9) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 16 | Calculate Risk Score (rule__2__10) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Needs Review |
| 17 | Determine Risk Tier (rule__3__11) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore < 20 THEN 'LOW' WHEN C.RiskScore < 50 THEN 'MODERATE' WHEN C.RiskScore < 80 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NULL | Not cited | Not cited | Not cited | Verified |
| 18 | Calculate Recommended Limit Adjustment Percentage (rule__4__12) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | Not cited | Not cited | Verified |
| 19 | Calculate Utilization Ratio (rule__1__17) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 20 | Calculate Risk Score (rule__2__18) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Needs Review |
| 21 | Calculate Recommended Limit Adjustment Percentage (rule__4__20) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN COALESCE(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0… | Not cited | Not cited | Not cited | Verified |
| 22 | Stage Updated Risk Scores and Tiers (rule__5) | INSERT INTO #RiskScoreStaging (CustomerId, RiskScore, RiskTier) SELECT CustomerId, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE RiskScore IS NOT NULL | Not cited | Not cited | Not cited | Verified |
| 23 | Merge Updated Risk Scores and Tiers into History (rule__6) | MERGE PRO.RiskScoreHistory AS Target USING #RiskScoreStaging AS Source ON Target.CustomerId = Source.CustomerId WHEN MATCHED THEN UPDATE SET Target.RiskScore = Source.RiskScore, Target.RiskTier = Source.RiskTier, Target.LastScoredDate = GETDATE() WHEN NOT MAT… | Not cited | Not cited | Not cited | Needs Review |
| 24 | Log Updated Risk Scores and Tiers for Audit (rule__7) | INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, GETDATE() AS ScoreDate, RiskScore, RiskTier FROM #RiskScoreStaging | Not cited | Not cited | Not cited | Needs Review |
| 25 | Calculate Utilization Ratio (rule__1__24) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 26 | Calculate Risk Score (rule__2__25) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Needs Review |
| 27 | Determine Risk Tier (rule__3__26) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore <= 50 THEN 'LOW' WHEN C.RiskScore > 50 AND C.RiskScore <= 100 THEN 'MODERATE' WHEN C.RiskScore > 100 AND C.RiskScore <= 150 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT N… | Not cited | Not cited | Not cited | Verified |
| 28 | Calculate Recommended Limit Adjustment Percentage (rule__4__27) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | Not cited | Not cited | Needs Review |
| 29 | Update Customer Risk Profile (rule__5__28) | UPDATE PRO.CustomerRiskProfile SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2), C.RiskTier = CASE WHEN C.RiskScore <= 50 THEN 'LOW' WHEN C.RiskScore > 50 AND C.Risk… | Not cited | Not cited | Not cited | Needs Review |
| 30 | Stage Risk Score and Risk Tier (rule__6__29) | INSERT INTO #RiskScoreStaging (CustomerId, RiskScore, RiskTier) SELECT CustomerId, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE RiskScore IS NOT NULL AND RiskTier IS NOT NULL | Not cited | Not cited | Not cited | Needs Review |
| 31 | Merge Risk Score and Risk Tier into History (rule__7__30) | MERGE INTO PRO.RiskScoreHistory AS Target USING #RiskScoreStaging AS Source ON Target.CustomerId = Source.CustomerId WHEN MATCHED THEN UPDATE SET Target.RiskScore = Source.RiskScore, Target.RiskTier = Source.RiskTier, Target.LastScoredDate = @ProcessDate WHEN… | Not cited | Not cited | Not cited | Needs Review |
| 32 | Log Risk Score and Risk Tier (rule__8) | INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, @ProcessDate, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE RiskScore IS NOT NULL AND RiskTier IS NOT NULL | Not cited | Not cited | Not cited | Needs Review |
| 33 | Calculate UtilizationRatio (rule__1__32) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 34 | Calculate RiskScore (rule__2__33) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Needs Review |
| 35 | Calculate RecommendedLimitAdjustmentPct (rule__4__35) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | Not cited | Not cited | Verified |
...
| decision_chain_004:branch_001 | C.RiskTier = 'LOW' AND ISNULL(C.PriorDefaultCount, 0) = 0 | source |
| decision_chain_004:branch_002 | C.RiskTier = 'LOW' AND ISNULL(C.PriorDefaultCount, 0)!= 0 | source |
| decision_chain_004:branch_003 | C.RiskTier = 'MODERATE' | source |
| decision_chain_004:branch_004 | C.RiskTier = 'HIGH' | source |
| decision_chain_004:branch_005 | C.RiskTier = 'SEVERE' | source |
| decision_chain_004:branch_006 | ELSE | source |
...
- **Disposition:** covered_by_rule=95, technical_only=2, uncovered=11
...
| IF_BRANCH | uncovered | samples/12_Customer_Risk_Score_Update.sql | full_source | C.RiskTier = 'LOW' AND ISNULL(C.PriorDefaultCount, 0) = 0 |
| IF_BRANCH | uncovered | samples/12_Customer_Risk_Score_Update.sql | full_source | C.RiskTier = 'LOW' AND ISNULL(C.PriorDefaultCount, 0)!= 0 |
...
- **By rule type:** deterministic_decision_table = 2, explicit = 33
- **By validation status:** unverified = 14, verified = 21
...
- **Quality score:** 86.06666666666668/100
- **Statement coverage:** 26 / 44 (59.1%)
- **Rule grounding coverage:** 30 / 35 (85.7%)
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: C.UtilizationRatio condition
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: C.RiskScore condition
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: C.RiskTier condition
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: C.RecommendedLimitAdjustmentPct condition
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore < 20 THEN 'LOW' WHEN C.RiskScore < 50 THEN 'MODERATE' WHEN C.RiskScore < 80 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NULL
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, GETDATE() AS ScoreDate, RiskScore, RiskTier FROM #RiskScoreStaging
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 END FROM PRO.CustomerRiskProfile C WHERE C.RiskTier IS NOT NULL
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE PRO.CustomerRiskProfile SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2), C.RiskTier = CASE WHEN C.RiskScore <= 50 THEN 'LOW' WHEN C.RiskScore > 50 AND C.RiskScore <= 100 THEN 'MODERATE' WHEN C.RiskScore > 100 AND C.RiskScore <= 150 THEN 'HIGH' ELSE 'SEVERE' END, C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 END FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO #RiskScoreStaging (CustomerId, RiskScore, RiskTier) SELECT CustomerId, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE RiskScore IS NOT NULL AND RiskTier IS NOT NULL
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, @ProcessDate, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE RiskScore IS NOT NULL AND RiskTier IS NOT NULL
