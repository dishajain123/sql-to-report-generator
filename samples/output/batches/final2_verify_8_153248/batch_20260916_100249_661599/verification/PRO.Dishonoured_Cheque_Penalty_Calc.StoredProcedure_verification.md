...
| Run Timestamp | `2026-09-16T10:03:59.349154+00:00` |
| Object ID | `obj_4c8f8a44b029` |
...
|---|---:|---:|---:|---:|---|
| extraction | 1 | 1 | 0 | 7130 | available |
| synthesis | 6 | 6 | 0 | 64355 | available |
| synthesis_revision | 1 | 1 | 0 | 30366 | available |

## Business Rule Summary

| Priority | Rule | Output | Business Purpose |
|---|---|---|---|
| 🔴 1 | Calculate penalty amount [CONFLICT] (`rule__1__6`) | `PenaltyAmount` | Determine the penalty amount for a dishonoured cheque based on the dishonour reason and repeat count. |
| 🟢 2 | Set hold for review [MATCHED] (`rule__2__7`) | `HoldForReview` | Mark a dishonoured cheque for review if it has not been penalized yet. |
| 🟢 3 | Mark penalty as applied [MATCHED] (`rule__3__8`) | `PenaltyApplied` | Mark the penalty as applied for a dishonoured cheque if it has a penalty amount. |
| 🟢 4 | Update outstanding balance [MATCHED] (`rule__4__9`) | `OutstandingBalance` | Update the outstanding balance for loan accounts affected by dishonoured cheques. |
| 🟢 5 | Insert penalty staging data [MATCHED] (`rule__5__10`) | `AccountId, PenaltyAmount, DishonourCount` | Insert staging data for penalty calculation into the penalty ledger. |
| 🟢 6 | Determine accounts for suspension [MATCHED] (`rule__6`) | `AccountId` | Determine which accounts need their cheque books suspended based on dishonour count. |
| 🟢 7 | Update penalty amount [MATCHED] (`rule__1__12`) | `PenaltyAmount` | Set the penalty amount for dishonoured cheques with a dishonour date matching the process date and no existing penalty amount. |
| 🟢 8 | Mark penalty applied [MATCHED] (`rule__2__13`) | `PenaltyApplied` | Mark cheques for which penalties have not been applied as applied. |
| 🟢 9 | Calculate dishonour count [MATCHED] (`rule__3__14`) | `DishonourCount` | Calculate the count of dishonoured cheques for each account within the lookback window. |
| 🟢 10 | Update account balance [MATCHED] (`rule__4__15`) | `OutstandingBalance` | Update the outstanding balance of loan accounts with a dishonour date matching the process date and a non-null penalty amount. |
| 🟢 11 | Suspend cheque book [MATCHED] (`rule__5__16`) | `AccountId` | Suspend cheque books for accounts with repeated dishonours. |
| 🟠 12 | Merge penalty data [UNRESOLVED] (`rule__6__17`) | `Not specified` | Merge penalty data into the cheque penalty ledger. |
| 🟢 13 | Log account status [MATCHED] (`rule__7`) | `Not specified` | Log account status transitions. |
| 🟢 14 | Hold cheque for review [MATCHED] (`rule__2__20`) | `HoldForReview` | Hold cheques for review if the dishonour date matches the process date and the dishonour reason is null. |
| 🟢 15 | Mark penalty as applied [MATCHED] (`rule__3__21`) | `PenaltyApplied` | Mark penalties as applied for dishonoured cheques with a dishonour date matching the process date and a non-null penalty amount. |
| 🟢 16 | Adjust outstanding balance [MATCHED] (`rule__4__22`) | `OutstandingBalance` | Adjust the outstanding balance for loan accounts with dishonoured cheques having a dishonour date matching the process date and a non-null… |
| 🟢 17 | Suspend cheque book [MATCHED] (`rule__5__23`) | `ChequeBookSuspended` | Suspend the cheque book for loan accounts with dishonoured cheques having a dishonour date matching the process date and a non-null penalty… |
| 🟢 18 | Suspend cheque book [MATCHED] (`rule__5__28`) | `ChequeBookSuspended` | Suspend the cheque book for accounts that have been dishonoured three or more times and have not already had their cheque book suspended. |
| 🟢 19 | Update penalty amount [MATCHED] (`rule__1`) | `PenaltyAmount` | Set the penalty amount for dishonoured cheques based on the time key. |
| 🟠 20 | Set cheques to hold for review [LLM_ONLY] (`rule__2`) | `HoldForReview` | Mark dishonoured cheques to hold for review based on the time key. |
| 🔴 21 | Apply penalty to cheques [CONFLICT] (`rule__3`) | `PenaltyApplied` | Apply the penalty to dishonoured cheques based on the time key. |
| 🟠 22 | Insert records into staging table [LLM_ONLY] (`rule__4`) | `AccountId, PenaltyAmount, DishonourCount` | Insert records into the staging table for further processing based on the time key. |
...
|---|---|---|---|---|---|---|
| 1 | Calculate penalty amount (rule__1__6) | UPDATE D SET D.PenaltyAmount = ( CASE WHEN D.DishonourReason IS NULL THEN NULL WHEN D.RepeatCount IS NULL OR D.RepeatCount = 0 THEN 350.00 WHEN D.RepeatCount = 1 THEN 750.00 ELSE 1500.00 END ) FROM PRO.DishonouredCheque D WHERE D.DishonourDate = @ProcessDate… | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_13 | 03_batch3_main_body+batch3_nested_block:embedded_01_13 | Needs Review |
| 2 | Set hold for review (rule__2__7) | UPDATE D SET D.HoldForReview = 'Y' FROM PRO.DishonouredCheque D WHERE D.DishonourDate = @ProcessDate AND D.PenaltyApplied = 'N' | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_22 | 03_batch3_main_body+batch3_nested_block:embedded_02_22 | Verified |
| 3 | Mark penalty as applied (rule__3__8) | UPDATE D SET D.PenaltyApplied = 'Y' FROM PRO.DishonouredCheque D WHERE D.DishonourDate = @ProcessDate AND NOT D.PenaltyAmount IS NULL | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_24 | 03_batch3_main_body+batch3_nested_block:embedded_04_24 | Verified |
| 4 | Update outstanding balance (rule__4__9) | UPDATE A SET A.OutstandingBalance = ISNULL(A.OutstandingBalance, 0) + D.PenaltyAmount FROM PRO.LoanAccountCal A INNER JOIN PRO.DishonouredCheque D ON D.AccountId = A.AccountId WHERE D.DishonourDate = @ProcessDate AND D.PenaltyAmount IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:chunk_text_07 | 03_batch3_main_body+batch3_nested_block:chunk_text_07 | Verified |
| 5 | Insert penalty staging data (rule__5__10) | INSERT INTO #PenaltyStaging (AccountId, PenaltyAmount, DishonourCount) SELECT D.AccountId, D.PenaltyAmount, (SELECT COUNT(*) FROM PRO.DishonouredCheque D2 WHERE D2.AccountId = D.AccountId AND D2.DishonourDate >= @LookbackWindowStart) FROM PRO.DishonouredChequ… | Not cited | 03_batch3_main_body+batch3_nested_block:chunk_text_12 | 03_batch3_main_body+batch3_nested_block:chunk_text_12 | Verified |
| 6 | Determine accounts for suspension (rule__6) | INSERT INTO #NewSuspensions (AccountId) SELECT P.AccountId FROM #PenaltyStaging P INNER JOIN PRO.LoanAccountCal A ON P.AccountId = A.AccountId WHERE P.DishonourCount >= 3 AND (A.ChequeBookSuspended <> 'Y' OR A.ChequeBookSuspended IS NULL) | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_07_27 | 03_batch3_main_body+batch3_nested_block:embedded_07_27 | Verified |
| 7 | Update penalty amount (rule__1__12) | D.DishonourDate = @ProcessDate AND D.PenaltyApplied = 'N' | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_13 | 03_batch3_main_body+batch3_nested_block:embedded_01_13 | Verified |
| 8 | Mark penalty applied (rule__2__13) | D.DishonourDate = @ProcessDate AND D.PenaltyAmount IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_24 | 03_batch3_main_body+batch3_nested_block:embedded_04_24 | Verified |
| 9 | Calculate dishonour count (rule__3__14) | D.DishonourDate = @ProcessDate AND D.PenaltyAmount IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:chunk_text_12 | 03_batch3_main_body+batch3_nested_block:chunk_text_12 | Verified |
| 10 | Update account balance (rule__4__15) | D.DishonourDate = @ProcessDate AND D.PenaltyAmount IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:chunk_text_07 | 03_batch3_main_body+batch3_nested_block:chunk_text_07 | Verified |
| 11 | Suspend cheque book (rule__5__16) | P.DishonourCount >= 3 AND (A.ChequeBookSuspended <> 'Y' OR A.ChequeBookSuspended IS NULL) | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_07_27 | 03_batch3_main_body+batch3_nested_block:embedded_07_27 | Verified |
| 12 | Merge penalty data (rule__6__17) | D.DishonourDate = @ProcessDate AND D.PenaltyAmount IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:chunk_text_19 | 03_batch3_main_body+batch3_nested_block:chunk_text_19 | Needs Review |
| 13 | Log account status (rule__7) | AccountId IN (SELECT AccountId FROM #NewSuspensions) | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_10_30 | 03_batch3_main_body+batch3_nested_block:embedded_10_30 | Verified |
| 14 | Hold cheque for review (rule__2__20) | D.DishonourDate = @ProcessDate AND D.DishonourReason IS NULL | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_22 | 03_batch3_main_body+batch3_nested_block:embedded_02_22 | Verified |
| 15 | Mark penalty as applied (rule__3__21) | D.DishonourDate = @ProcessDate AND NOT D.PenaltyAmount IS NULL | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_24 | 03_batch3_main_body+batch3_nested_block:embedded_04_24 | Verified |
| 16 | Adjust outstanding balance (rule__4__22) | D.DishonourDate = @ProcessDate AND NOT D.PenaltyAmount IS NULL | Not cited | 03_batch3_main_body+batch3_nested_block:chunk_text_07 | 03_batch3_main_body+batch3_nested_block:chunk_text_07 | Verified |
| 17 | Suspend cheque book (rule__5__23) | D.DishonourDate = @ProcessDate AND D.PenaltyAmount IS NOT NULL | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_23 | 03_batch3_main_body+batch3_nested_block:embedded_03_23 | Verified |
| 18 | Suspend cheque book (rule__5__28) | P.DishonourCount >= 3 AND (A.ChequeBookSuspended <> 'Y' OR A.ChequeBookSuspended IS NULL) | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_07_27 | Not cited | Verified |
| 19 | Update penalty amount (rule__1) | D.PenaltyAmount | Not cited | Not cited | Not cited | Verified |
| 20 | Set cheques to hold for review (rule__2) | D.HoldForReview | Not cited | Not cited | Not cited | Needs Review |
| 21 | Apply penalty to cheques (rule__3) | D.PenaltyApplied | Not cited | Not cited | Not cited | Needs Review |
| 22 | Insert records into staging table (rule__4) | INSERT INTO #PenaltyStaging | Not cited | Not cited | Not cited | Needs Review |
...
- **By validation status:** unverified = 5, verified = 17
...
- **Quality score:** 84.25149350649349/100
- **Statement coverage:** 30 / 50 (60.0%)
- **Rule grounding coverage:** 20 / 22 (90.9%)
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO #NewSuspensions (AccountId)
        SELECT P.AccountId
