...
| Run Timestamp | `2026-09-16T10:02:49.703923+00:00` |
| Object ID | `obj_4117700b7512` |
...
| Item | Value |
|---|---|
| Run ID | `telemetry_b4ac10fee8f4` |
| Total LLM Calls | `9` |
| Successful Calls | `9` |
| Failed Calls | `0` |
| Prompt Tokens | `95629` |
| Completion Tokens | `21683` |
| Total Tokens | `117312` |
| Telemetry Availability | `available` |

| Stage | Calls | Success | Failure | Tokens | Availability |
|---|---:|---:|---:|---:|---|
| extraction | 1 | 1 | 0 | 7020 | available |
| synthesis | 7 | 7 | 0 | 75208 | available |
| synthesis_revision | 1 | 1 | 0 | 35084 | available |

## Business Rule Summary

| Priority | Rule | Output | Business Purpose |
|---|---|---|---|
| 🔴 1 | Update severity tier [CONFLICT] (`rule__3__13`) | `SeverityTier` | Update the SeverityTier in the #ReconciliationResults table based on the outcome and shortfall percentage. |
| 🟢 2 | Merge reconciliation summary [MATCHED] (`rule__4__14`) | `Target.FeedName, Source.FeedName, Target.Outcome, Source.Outcome, Target.ShortfallPct, Source.ShortfallPct, Target.SeverityTier, Source.SeverityTier, Target.LastReconciledDate, Source.ReconciledOn, FeedName, Outcome, ShortfallPct, SeverityTier, FirstReconciledDate, LastReconciledDate` | Merge reconciliation summary data into the PRO.BatchReconciliationSummary table. |
| 🟢 3 | Update retry count [MATCHED] (`rule__2__15`) | `RetryCount` | Update the RetryCount in the PRO.BatchFeedRegistry table for feeds that need to be retried. |
| 🔴 4 | Update severity tier [CONFLICT] (`rule__3__16`) | `SeverityTier` | Update the SeverityTier in the #ReconciliationResults table based on certain conditions. |
| 🟢 5 | Merge reconciliation summary [MATCHED] (`rule__4__17`) | `Target.FeedName, Source.FeedName, Target.Outcome, Source.Outcome, Target.ShortfallPct, Source.ShortfallPct, Target.SeverityTier, Source.SeverityTier, Target.LastReconciledDate, Source.ReconciledOn, FeedName, Outcome, ShortfallPct, SeverityTier, FirstReconciledDate, LastReconciledDate` | Merge reconciliation summary data into the PRO.BatchReconciliationSummary table. |
| 🟢 6 | Update severity tier summary [MATCHED] (`rule__5__18`) | `SeverityTier` | Update the SeverityTier in the PRO.BatchReconciliationSummary table for feeds that have not been reconciled within the last 14 days. |
| 🔴 7 | Read batch feed registry [CONFLICT] (`rule__9__19`) | `Outcome, ShortfallPct` | Read the PRO.BatchFeedRegistry table to determine the outcome and shortfall percentage for each feed. |
| 🟢 8 | Update retry count for feeds [MATCHED] (`rule__2__20`) | `RetryCount` | Update the RetryCount in the PRO.BatchFeedRegistry table for feeds that need to be retried. |
| 🟢 9 | Update severity tier for older records [MATCHED] (`rule__3__21`) | `SeverityTier` | Update the SeverityTier in the PRO.BatchReconciliationSummary table for older records. |
| 🔴 10 | Insert collections queue entries [CONFLICT] (`rule__5__22`) | `AccountId, EscalationDate, Reason` | Insert records into the PRO.CollectionsQueue table for feeds that failed reconciliation. |
| 🟠 11 | Determine Outcome [MATCHED] (`deterministic_decision_1739_2891_1_outcome`) | `Outcome` | First matching row wins. SQL type conversion still applies; ELSE includes false or NULL predicates. |
| 🟠 12 | Determine ShortfallPct [MATCHED] (`deterministic_decision_1739_2891_2_shortfallpct`) | `ShortfallPct` | First matching row wins. SQL type conversion still applies; ELSE includes false or NULL predicates. |
| 🟠 13 | Determine Reason [MATCHED] (`deterministic_decision_5530_5841_2_reason`) | `Reason` | First matching row wins. SQL type conversion still applies; ELSE includes false or NULL predicates. |
| 🟠 14 | Update SeverityTier based on conditions [LLM_ONLY] (`rule__2`) | `SeverityTier` | Updates the SeverityTier field in the temporary table based on specific conditions. |
| 🟢 15 | Insert reconciliation results [MATCHED] (`rule__1`) | `Outcome, FeedName, ShortfallPct, SeverityTier, ReconciledOn` | Insert initial reconciliation results into the temporary table based on batch feed registry data. |
| 🟠 16 | Update severity tier [LLM_ONLY] (`rule__2__3`) | `SeverityTier` | Update the severity tier in the temporary table based on specific conditions. |
| 🟠 17 | Merge reconciliation summary [LLM_ONLY] (`rule__3`) | `SeverityTier, Target.FeedName, Source.FeedName, Target.Outcome, Source.Outcome, Target.ShortfallPct, Source.ShortfallPct, Target.SeverityTier, Source.SeverityTier, Target.LastReconciledDate, Source.ReconciledOn, FeedName, Outcome, ShortfallPct, FirstReconciledDate, LastReconciledDate` | Merge reconciliation summary data into the batch reconciliation summary table. |
| 🟢 18 | Update retry count [MATCHED] (`rule__2__6`) | `RetryCount` | Update the RetryCount in the PRO.BatchFeedRegistry table for feeds that need to be retried. |
| 🟠 19 | Merge reconciliation summary [LLM_ONLY] (`rule__4`) | `FeedName, Outcome, ShortfallPct, SeverityTier, ReconciledOn` | Merge reconciliation summary data from the #ReconciliationResults temporary table into the PRO.BatchReconciliationSummary table. |
| 🟢 20 | Update severity tier in summary [MATCHED] (`rule__5`) | `SeverityTier` | Update the SeverityTier in the PRO.BatchReconciliationSummary table for feeds that have not been reconciled and were reconciled more than 1… |
| 🔴 21 | Insert reconciliation log [CONFLICT] (`rule__6`) | `FeedName, Outcome, ReconciledOn` | Insert reconciliation outcomes into the PRO.BatchReconciliationLog table. |
| 🟠 22 | Insert collections queue [LLM_ONLY] (`rule__7`) | `AccountId, EscalationDate, Reason` | Insert data into the PRO.CollectionsQueue table for accounts that need escalation. |
| 🔴 23 | Read batch feed registry [CONFLICT] (`rule__9`) | `Outcome, FeedName, ShortfallPct, SeverityTier, FirstReconciledDate, LastReconciledDate` | Read batch feed registry data to determine the outcome and shortfall percentage for each feed. |
...
|---|---|---|---|---|---|---|
| 1 | Update severity tier (rule__3__13) | UPDATE R SET R.SeverityTier = CASE... END FROM #ReconciliationResults R | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_19 | 03_batch3_main_body+batch3_nested_block:embedded_03_19 | Verified |
| 2 | Merge reconciliation summary (rule__4__14) | MERGE PRO.BatchReconciliationSummary AS Target USING (SELECT * FROM #ReconciliationResults) AS Source ON Target.FeedName = Source.FeedName WHEN MATCHED THEN UPDATE SET... WHEN NOT MATCHED BY TARGET THEN INSERT... | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_06_22 | 03_batch3_main_body+batch3_nested_block:embedded_06_22 | Verified |
| 3 | Update retry count (rule__2__15) | UPDATE PRO.BatchFeedRegistry SET RetryCount = RetryCount + 1 WHERE FeedDate = @ProcessDate AND FeedName IN (SELECT FeedName FROM #ReconciliationResults WHERE Outcome = 'RETRY_QUEUED') | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_17 | 03_batch3_main_body+batch3_nested_block:embedded_01_17 | Verified |
| 4 | Update severity tier (rule__3__16) | UPDATE #ReconciliationResults SET SeverityTier = CASE... END WHERE... | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_19 | 03_batch3_main_body+batch3_nested_block:embedded_03_19 | Verified |
| 5 | Merge reconciliation summary (rule__4__17) | MERGE INTO PRO.BatchReconciliationSummary... | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_20 | 03_batch3_main_body+batch3_nested_block:embedded_04_20 | Verified |
| 6 | Update severity tier summary (rule__5__18) | UPDATE PRO.BatchReconciliationSummary SET SeverityTier = CASE... END WHERE T.Outcome <> 'RECONCILED' AND T.FirstReconciledDate <= DATEADD(DAY, -14, @ProcessDate) | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_05_21 | 03_batch3_main_body+batch3_nested_block:embedded_05_21 | Verified |
| 7 | Read batch feed registry (rule__9__19) | SELECT FeedName, CASE... END AS Outcome, CASE... END AS ShortfallPct FROM PRO.BatchFeedRegistry WHERE FeedDate = @ProcessDate | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_09_25 | 03_batch3_main_body+batch3_nested_block:embedded_09_25 | Verified |
| 8 | Update retry count for feeds (rule__2__20) | UPDATE PRO.BatchFeedRegistry SET RetryCount = RetryCount + 1 WHERE FeedDate = @ProcessDate AND FeedName IN (SELECT FeedName FROM #ReconciliationResults WHERE Outcome = 'RETRY_QUEUED') | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_18 | 03_batch3_main_body+batch3_nested_block:embedded_02_18 | Verified |
| 9 | Update severity tier for older records (rule__3__21) | UPDATE T SET T.SeverityTier = 'CRITICAL' FROM PRO.BatchReconciliationSummary T WHERE T.Outcome <> 'RECONCILED' AND T.FirstReconciledDate <= DATEADD(DAY, -14, @ProcessDate) | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_19 | 03_batch3_main_body+batch3_nested_block:embedded_03_19 | Verified |
| 10 | Insert collections queue entries (rule__5__22) | INSERT INTO PRO.CollectionsQueue (AccountId, EscalationDate, Reason) SELECT FeedName, ReconciledOn, CASE... END FROM #ReconciliationResults WHERE Outcome = 'FAILED' | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_07_23 | 03_batch3_main_body+batch3_nested_block:embedded_07_23 | Needs Review |
| 11 | Determine Outcome (deterministic_decision_1739_2891_1_outcome) | Not cited | source \| Lines 46-70 | Not cited | Not cited | Verified |
| 12 | Determine ShortfallPct (deterministic_decision_1739_2891_2_shortfallpct) | Not cited | source \| Lines 46-70 | Not cited | Not cited | Verified |
| 13 | Determine Reason (deterministic_decision_5530_5841_2_reason) | Not cited | source \| Lines 123-129 | Not cited | Not cited | Verified |
| 14 | Update SeverityTier based on conditions (rule__2) | UPDATE R SET R.SeverityTier = CASE... | Not cited | Not cited | Not cited | Needs Review |
| 15 | Insert reconciliation results (rule__1) | INSERT INTO #ReconciliationResults (FeedName, Outcome, ShortfallPct, SeverityTier, ReconciledOn) SELECT FeedName, CASE... END, NULL, @ProcessDate FROM PRO.BatchFeedRegistry WHERE FeedDate = @ProcessDate | Not cited | Not cited | Not cited | Verified |
| 16 | Update severity tier (rule__2__3) | UPDATE #ReconciliationResults SET R.SeverityTier = CASE... END | Not cited | Not cited | Not cited | Needs Review |
| 17 | Merge reconciliation summary (rule__3) | MERGE INTO PRO.BatchReconciliationSummary... | Not cited | Not cited | Not cited | Needs Review |
| 18 | Update retry count (rule__2__6) | UPDATE PRO.BatchFeedRegistry SET RetryCount = 1 WHERE FeedDate = @ProcessDate AND FeedName IN (SELECT FeedName FROM #ReconciliationResults WHERE Outcome = 'RETRY_QUEUED') | Not cited | Not cited | Not cited | Verified |
| 19 | Merge reconciliation summary (rule__4) | MERGE INTO PRO.BatchReconciliationSummary WITH (HOLDLOCK) AS Target USING #ReconciliationResults AS Source ON Target.FeedName = Source.FeedName AND Target.FeedDate = Source.FeedDate WHEN MATCHED THEN UPDATE SET Target.Outcome = Source.Outcome, Target.Shortfal… | Not cited | Not cited | Not cited | Needs Review |
| 20 | Update severity tier in summary (rule__5) | UPDATE PRO.BatchReconciliationSummary SET T.SeverityTier = 'CRITICAL' WHERE T.Outcome <> 'RECONCILED' AND T.FirstReconciledDate <= DATEADD(DAY, -14, @ProcessDate) | Not cited | Not cited | Not cited | Verified |
| 21 | Insert reconciliation log (rule__6) | INSERT INTO PRO.BatchReconciliationLog (FeedName, Outcome, ReconciledOn) SELECT FeedName, Outcome, ReconciledOn FROM #ReconciliationResults WHERE Outcome = 'RETRY_QUEUED' OR Outcome = 'FAILED' | Not cited | Not cited | Not cited | Needs Review |
| 22 | Insert collections queue (rule__7) | INSERT INTO PRO.CollectionsQueue (AccountId, EscalationDate, Reason) SELECT AccountId, EscalationDate, Reason FROM... WHERE AccountId is eligible for escalation | Not cited | Not cited | Not cited | Needs Review |
| 23 | Read batch feed registry (rule__9) | SELECT FeedName, CASE... END AS Outcome, CASE... END AS ShortfallPct, SeverityTier, FirstReconciledDate, LastReconciledDate FROM PRO.BatchFeedRegistry WHERE FeedDate = @ProcessDate | Not cited | Not cited | Not cited | Needs Review |
...
| decision_chain_005:branch_001 | R.Outcome = 'RECONCILED' | source |
| decision_chain_005:branch_002 | R.Outcome = 'NOT_APPLICABLE' | source |
| decision_chain_005:branch_003 | R.Outcome = 'RETRY_QUEUED' | source |
| decision_chain_005:branch_004 | R.Outcome = 'FAILED' AND R.ShortfallPct > 25 | source |
| decision_chain_005:branch_005 | R.Outcome = 'FAILED' | source |
| decision_chain_005:branch_006 | ELSE | source |
...
- **Disposition:** covered_by_rule=76, technical_only=8, uncovered=21
...
- **By rule type:** deterministic_decision_table = 3, explicit = 20
...
- **Quality score:** 76.33280632411066/100
- **Statement coverage:** 24 / 36 (66.7%)
- **Rule grounding coverage:** 15 / 23 (65.2%)
...
- `MEDIUM` Field Conflict on `rule__6`: Synthesized rule affects different fields than the deterministic evidence.
- `MEDIUM` Field Conflict on `rule__9`: Synthesized rule affects different fields than the deterministic evidence.
- `HIGH` Outcome Conflict on `rule__3__13`: Synthesized outcome/assignment conflicts with deterministic evidence.

_Quality is derived deterministically from parse success, grounding, conflicts, contradictions, and dialect support._

## Pipeline Diagnostics

- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE R SET R.SeverityTier = CASE...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO #ReconciliationResults (FeedName, Outcome, ShortfallPct, SeverityTier, ReconciledOn) SELECT FeedName, CASE... END, NULL, @ProcessDate FROM PRO.BatchFeedRegistry WHERE FeedDate = @ProcessDate
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE #ReconciliationResults SET R.SeverityTier = CASE... END
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE #ReconciliationResults SET R.SeverityTier = CASE WHEN SeverityTier = 'CRITICAL' THEN 'FEED_RECONCILIATION_CRITICAL' ELSE 'FEED_RECONCILIATION_FAILED' END
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: MERGE INTO PRO.BatchReconciliationSummary WITH (HOLDLOCK) AS Target USING #ReconciliationResults AS Source ON Target.FeedName = Source.FeedName AND Target.FeedDate = Source.FeedDate WHEN MATCHED THEN UPDATE SET Target.Outcome = Source.Outcome, Target.ShortfallPct = Source.ShortfallPct, Target.SeverityTier = Source.SeverityTier, Target.LastReconciledDate = Source.ReconciledOn WHEN NOT MATCHED BY TARGET THEN INSERT (Target.FeedName, Target.Outcome, Target.ShortfallPct, Target.SeverityTier, Target.LastReconciledDate) VALUES (Source.FeedName, Source.Outcome, Source.ShortfallPct, Source.SeverityTier, Source.ReconciledOn)
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE PRO.BatchReconciliationSummary SET T.SeverityTier = 'CRITICAL' WHERE T.Outcome <> 'RECONCILED' AND T.FirstReconciledDate <= DATEADD(DAY, -14, @ProcessDate)
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO PRO.BatchReconciliationLog (FeedName, Outcome, ReconciledOn) SELECT FeedName, Outcome, ReconciledOn FROM #ReconciliationResults WHERE Outcome = 'RETRY_QUEUED' OR Outcome = 'FAILED'
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO PRO.CollectionsQueue (AccountId, EscalationDate, Reason) SELECT AccountId, EscalationDate, Reason FROM... WHERE AccountId is eligible for escalation
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: SELECT FeedName, CASE... END AS Outcome, CASE... END AS ShortfallPct, SeverityTier, FirstReconciledDate, LastReconciledDate FROM PRO.BatchFeedRegistry WHERE FeedDate = @ProcessDate
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: MERGE PRO.BatchReconciliationSummary AS Target USING (SELECT * FROM #ReconciliationResults) AS Source ON Target.FeedName = Source.FeedName WHEN MATCHED THEN UPDATE SET... WHEN NOT MATCHED BY TARGET THEN INSERT...
