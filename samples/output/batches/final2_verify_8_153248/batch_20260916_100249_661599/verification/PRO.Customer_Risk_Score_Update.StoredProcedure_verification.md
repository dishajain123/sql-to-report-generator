...
| Run Timestamp | `2026-09-16T10:04:54.937498+00:00` |
| Object ID | `obj_9cfe9a17e845` |
...
| Item | Value |
|---|---|
| Run ID | `telemetry_68c1e5f71487` |
| Total LLM Calls | `9` |
| Successful Calls | `9` |
| Failed Calls | `0` |
| Prompt Tokens | `114091` |
| Completion Tokens | `17820` |
| Total Tokens | `131911` |
| Telemetry Availability | `available` |

| Stage | Calls | Success | Failure | Tokens | Availability |
|---|---:|---:|---:|---:|---|
| extraction | 1 | 1 | 0 | 7053 | available |
| synthesis | 7 | 7 | 0 | 92057 | available |
| synthesis_revision | 1 | 1 | 0 | 32801 | available |

## Business Rule Summary

| Priority | Rule | Output | Business Purpose |
|---|---|---|---|
| 🟢 1 | Update UtilizationRatio [MATCHED] (`rule__1`) | `UtilizationRatio` | Set the UtilizationRatio for customers based on their utilization levels. |
| 🔴 2 | Update RiskScore [CONFLICT] (`rule__2`) | `RiskScore` | Set the RiskScore for customers based on their risk level. |
| 🔴 3 | Update RiskTier [CONFLICT] (`rule__3`) | `RiskTier` | Set the RiskTier for customers based on their risk score. |
| 🔴 4 | Update RecommendedLimitAdjustmentPct [CONFLICT] (`rule__4`) | `RecommendedLimitAdjustmentPct` | Set the RecommendedLimitAdjustmentPct for customers based on their risk profile. |
| 🟢 5 | Calculate UtilizationRatio [MATCHED] (`rule__1__5`) | `UtilizationRatio` | Determine the UtilizationRatio for customers with a non-null and positive CreditLimit. |
| 🟢 6 | Calculate RiskScore [MATCHED] (`rule__2__6`) | `RiskScore` | Determine the RiskScore for customers based on overdue days, utilization ratio, and prior defaults. |
| 🔴 7 | Determine RiskTier [CONFLICT] (`rule__3__7`) | `RiskTier` | Determine the RiskTier for customers based on the RiskScore. |
| 🔴 8 | Calculate RecommendedLimitAdjustmentPct [CONFLICT] (`rule__4__8`) | `RecommendedLimitAdjustmentPct` | Determine the RecommendedLimitAdjustmentPct for customers based on their RiskTier and PriorDefaultCount. |
...
| 🟢 11 | Calculate Utilization Ratio [MATCHED] (`rule__1__9`) | `UtilizationRatio` | Determine the utilization ratio for a customer by dividing their current balance by their credit limit. |
| 🟠 12 | Calculate Risk Score [LLM_ONLY] (`rule__2__10`) | `RiskScore` | Determine the risk score for a customer based on their overdue days, utilization ratio, and prior default count. |
| 🔴 13 | Determine Risk Tier [CONFLICT] (`rule__3__11`) | `RiskTier` | Assign a risk tier to a customer based on their risk score. |
| 🟢 14 | Calculate Recommended Limit Adjustment Percentage [MATCHED] (`rule__4__12`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for a customer based on their risk tier and prior default count. |
| 🟢 15 | Calculate Utilization Ratio [MATCHED] (`rule__1__13`) | `UtilizationRatio` | Determine the utilization ratio for a customer by dividing their current balance by their credit limit. |
| 🟠 16 | Calculate Risk Score [LLM_ONLY] (`rule__2__14`) | `RiskScore` | Determine the risk score for a customer by combining their overdue days, utilization ratio, and prior default count. |
| 🟠 17 | Determine Risk Tier [LLM_ONLY] (`rule__3__15`) | `RiskTier` | Classify the risk tier for a customer based on their risk score. |
| 🟢 18 | Calculate Recommended Limit Adjustment Percentage [MATCHED] (`rule__4__16`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for a customer based on their risk tier and prior default count. |
...
| 🟢 21 | Determine Risk Tier [MATCHED] (`rule__3__19`) | `RiskTier` | Determine the risk tier for customers based on their composite risk score. |
| 🟢 22 | Calculate Recommended Limit Adjustment Percentage [MATCHED] (`rule__4__20`) | `RecommendedLimitAdjustmentPct` | Determine the recommended limit adjustment percentage for customers based on their risk tier and prior defaults. |
| 🟢 23 | Stage Updated Risk Scores and Tiers [MATCHED] (`rule__5`) | `Not specified` | Stage the updated risk scores and tiers for customers. |
| 🟠 24 | Merge Updated Risk Scores and Tiers into History [LLM_ONLY] (`rule__6`) | `Not specified` | Merge the staged risk scores and tiers into the risk score history. |
| 🟠 25 | Log Updated Risk Scores and Tiers for Audit [UNRESOLVED] (`rule__7`) | `Not specified` | Log the updated risk scores and tiers for audit purposes. |
| 🟢 26 | Calculate Utilization Ratio [MATCHED] (`rule__1__24`) | `UtilizationRatio` | Determine the utilization ratio for customers with a non-null and positive credit limit. |
| 🔴 27 | Calculate Risk Score [CONFLICT] (`rule__2__25`) | `RiskScore` | Determine the risk score for customers based on overdue days, utilization ratio, and prior defaults. |
...
| 🟠 34 | Calculate RiskScore [LLM_ONLY] (`rule__2__33`) | `RiskScore` | Calculate the risk score for each customer based on overdue days, utilization ratio, and prior defaults. |
...
|---|---|---|---|---|---|---|
| 1 | Update UtilizationRatio (rule__1) | C.UtilizationRatio condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_29 | Not cited | Verified |
| 2 | Update RiskScore (rule__2) | C.RiskScore condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_30 | Not cited | Needs Review |
| 3 | Update RiskTier (rule__3) | C.RiskTier condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_31 | Not cited | Needs Review |
| 4 | Update RecommendedLimitAdjustmentPct (rule__4) | C.RecommendedLimitAdjustmentPct condition | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_32 | Not cited | Needs Review |
| 5 | Calculate UtilizationRatio (rule__1__5) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_01_29 | dependency_0001; dependency_0002 | Verified |
| 6 | Calculate RiskScore (rule__2__6) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_02_30 | dependency_0003; dependency_0004 | Verified |
| 7 | Determine RiskTier (rule__3__7) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore < 50 THEN 'LOW' WHEN C.RiskScore >= 50 AND C.RiskScore < 100 THEN 'MODERATE' WHEN C.RiskScore >= 100 AND C.RiskScore < 150 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NU… | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_03_31 | dependency_0005; dependency_0006 | Needs Review |
| 8 | Calculate RecommendedLimitAdjustmentPct (rule__4__8) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | 03_batch3_main_body+batch3_nested_block:embedded_04_32 | dependency_0007; dependency_0008; dependency_0009; dependency_0010; dependency_0011 | Needs Review |
...
| 11 | Calculate Utilization Ratio (rule__1__9) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 12 | Calculate Risk Score (rule__2__10) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C -- Rule 3: multi-branch risk tier derived from the composite score | Not cited | Not cited | Not cited | Needs Review |
| 13 | Determine Risk Tier (rule__3__11) | UPDATE C SET C.RiskTier = ( CASE WHEN C.RiskScore < 20 THEN 'LOW' WHEN C.RiskScore < 50 THEN 'MODERATE' WHEN C.RiskScore < 80 THEN 'HIGH' END ) FROM PRO.CustomerRiskProfile C | Not cited | Not cited | Not cited | Needs Review |
| 14 | Calculate Recommended Limit Adjustment Percentage (rule__4__12) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | Not cited | Not cited | Verified |
| 15 | Calculate Utilization Ratio (rule__1__13) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 16 | Calculate Risk Score (rule__2__14) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C -- Rule 3: multi-branch risk tier derived from the composite score | Not cited | Not cited | Not cited | Verified |
| 17 | Determine Risk Tier (rule__3__15) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore <= 50 THEN 'LOW' WHEN C.RiskScore > 50 AND C.RiskScore <= 100 THEN 'MODERATE' WHEN C.RiskScore > 100 AND C.RiskScore <= 150 THEN 'HIGH' WHEN C.RiskScore > 150 THEN 'SEVERE' END FROM PRO.CustomerRiskProfile C | Not cited | Not cited | Not cited | Verified |
| 18 | Calculate Recommended Limit Adjustment Percentage (rule__4__16) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN ISNULL(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0 E… | Not cited | Not cited | Not cited | Verified |
...
| 21 | Determine Risk Tier (rule__3__19) | UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore < 50 THEN 'LOW' WHEN C.RiskScore >= 50 AND C.RiskScore < 75 THEN 'MODERATE' WHEN C.RiskScore >= 75 AND C.RiskScore < 100 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NULL | Not cited | Not cited | Not cited | Verified |
| 22 | Calculate Recommended Limit Adjustment Percentage (rule__4__20) | UPDATE C SET C.RecommendedLimitAdjustmentPct = CASE WHEN C.RiskTier = 'LOW' THEN CASE WHEN COALESCE(C.PriorDefaultCount, 0) = 0 THEN 10 ELSE 0 END WHEN C.RiskTier = 'MODERATE' THEN 0 WHEN C.RiskTier = 'HIGH' THEN -15 WHEN C.RiskTier = 'SEVERE' THEN -40 ELSE 0… | Not cited | Not cited | Not cited | Verified |
| 23 | Stage Updated Risk Scores and Tiers (rule__5) | INSERT INTO #RiskScoreStaging (CustomerId, RiskScore, RiskTier) SELECT CustomerId, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE RiskScore IS NOT NULL | Not cited | Not cited | Not cited | Verified |
| 24 | Merge Updated Risk Scores and Tiers into History (rule__6) | MERGE PRO.RiskScoreHistory AS Target USING (SELECT CustomerId, RiskScore, RiskTier, @ProcessDate AS LastScoredDate FROM #RiskScoreStaging) AS Source ON Target.CustomerId = Source.CustomerId WHEN MATCHED THEN UPDATE SET Target.RiskScore = Source.RiskScore, Tar… | Not cited | Not cited | Not cited | Needs Review |
| 25 | Log Updated Risk Scores and Tiers for Audit (rule__7) | INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, @ProcessDate, RiskScore, RiskTier FROM #RiskScoreStaging WHERE CustomerId IS NOT NULL AND RiskScore IS NOT NULL AND RiskTier IS NOT NULL | Not cited | Not cited | Not cited | Needs Review |
| 26 | Calculate Utilization Ratio (rule__1__24) | UPDATE C SET C.UtilizationRatio = C.CurrentBalance / C.CreditLimit FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Verified |
| 27 | Calculate Risk Score (rule__2__25) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C WHERE C.CreditLimit IS NOT NULL AND C.CreditLimit > 0 | Not cited | Not cited | Not cited | Needs Review |
...
| 30 | Stage Risk Score and Risk Tier (rule__6__29) | INSERT INTO #RiskScoreStaging (CustomerId, RiskScore, RiskTier) SELECT CustomerId, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE C.RiskScore IS NOT NULL AND C.RiskTier IS NOT NULL | Not cited | Not cited | Not cited | Needs Review |
...
| 32 | Log Risk Score and Risk Tier (rule__8) | INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, @ProcessDate, RiskScore, RiskTier FROM PRO.CustomerRiskProfile WHERE C.RiskScore IS NOT NULL AND C.RiskTier IS NOT NULL | Not cited | Not cited | Not cited | Needs Review |
...
| 34 | Calculate RiskScore (rule__2__33) | UPDATE C SET C.RiskScore = (ISNULL(C.OverdueDays, 0) * 0.5) + (ISNULL(C.UtilizationRatio, 0) * 100 * 0.3) + (ISNULL(C.PriorDefaultCount, 0) * 20 * 0.2) FROM PRO.CustomerRiskProfile C -- Rule 3: multi-branch risk tier derived from the composite score | Not cited | Not cited | Not cited | Verified |
...
| decision_chain_004:branch_002 | C.RiskTier = 'MODERATE' | source |
| decision_chain_004:branch_003 | C.RiskTier = 'HIGH' | source |
| decision_chain_004:branch_004 | C.RiskTier = 'SEVERE' | source |
| decision_chain_004:branch_005 | ELSE | source |
...
- **Disposition:** covered_by_rule=95, technical_only=2, uncovered=10
...
- **Total business rules:** 34
- **By rule type:** deterministic_decision_table = 2, explicit = 32
- **By validation status:** unverified = 16, verified = 18
...
- **Quality score:** 84.33613445378153/100
- **Statement coverage:** 26 / 44 (59.1%)
- **Rule grounding coverage:** 26 / 34 (76.5%)
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE C
            SET C.RiskTier =
                CASE
                    WHEN C.RiskScore <= 50 THEN 'LOW'
                    WHEN C.RiskScore > 50 AND C.RiskScore <= 100 THEN 'MODERATE'
                    WHEN C.RiskScore > 100 AND C.RiskScore <= 150 THEN 'HIGH'
                    WHEN C.RiskScore > 150 THEN 'SEVERE'
                END
            FROM PRO.CustomerRiskProfile C
...
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: MERGE PRO.RiskScoreHistory AS Target USING (SELECT CustomerId, RiskScore, RiskTier, @ProcessDate AS LastScoredDate FROM #RiskScoreStaging) AS Source ON Target.CustomerId = Source.CustomerId WHEN MATCHED THEN UPDATE SET Target.RiskScore = Source.RiskScore, Target.RiskTier = Source.RiskTier, Target.LastScoredDate = Source.LastScoredDate WHEN NOT MATCHED BY TARGET THEN INSERT (CustomerId, RiskScore, RiskTier, FirstScoredDate, LastScoredDate) VALUES (Source.CustomerId, Source.RiskScore, Source.RiskTier, Source.LastScoredDate, Source.LastScoredDate)
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: INSERT INTO PRO.RiskScoreAuditLog (CustomerId, ScoreDate, RiskScore, RiskTier) SELECT CustomerId, @ProcessDate, RiskScore, RiskTier FROM #RiskScoreStaging WHERE CustomerId IS NOT NULL AND RiskScore IS NOT NULL AND RiskTier IS NOT NULL
- Could not trace the stated source evidence back to a successfully parsed technical extraction record: UPDATE C SET C.RiskTier = CASE WHEN C.RiskScore <= 50 THEN 'LOW' WHEN C.RiskScore > 50 AND C.RiskScore <= 100 THEN 'MODERATE' WHEN C.RiskScore > 100 AND C.RiskScore <= 150 THEN 'HIGH' ELSE 'SEVERE' END FROM PRO.CustomerRiskProfile C WHERE C.RiskScore IS NOT NULL
